 ...
 * @return Colors\Color
 */
function mix(\LearnDash\Gradebook\SSNepenthe\ColorUtils\Colors\Color $color1, \LearnDash\Gradebook\SSNepenthe\ColorUtils\Colors\Color $color2, int $weight = 50): Colors\Color
{

...
namespace LearnDash\Gradebook\SSNepenthe\ColorUtils\Colors;

use LearnDash\Gradebook\SSNepenthe\ColorUtils\Converters\HslToRgb;
use LearnDash\Gradebook\SSNepenthe\ColorUtils\Converters\RgbToHsl;
use function LearnDash\Gradebook\SSNepenthe\ColorUtils\contrast_ratio;
use LearnDash\Gradebook\SSNepenthe\ColorUtils\Exceptions\RuntimeException;
use LearnDash\Gradebook\SSNepenthe\ColorUtils\Converters\ConverterInterface;
use function LearnDash\Gradebook\SSNepenthe\ColorUtils\array_contains_one_of;
use LearnDash\Gradebook\SSNepenthe\ColorUtils\Exceptions\BadMethodCallException;
use LearnDash\Gradebook\SSNepenthe\ColorUtils\Exceptions\InvalidArgumentException;
...
class Color
{
    ...
    protected function makeConverter(ColorInterface $color) : ConverterInterface
    {
        switch (get_class($color)) {
            case 'LearnDash\\Gradebook\\SSNepenthe\\ColorUtils\\Colors\\Rgb':
            case 'LearnDash\\Gradebook\\SSNepenthe\\ColorUtils\\Colors\\Rgba':
                return new RgbToHsl;
            case 'LearnDash\\Gradebook\\SSNepenthe\\ColorUtils\\Colors\\Hsl':
            case 'LearnDash\\Gradebook\\SSNepenthe\\ColorUtils\\Colors\\Hsla':
                return new HslToRgb;
            default:

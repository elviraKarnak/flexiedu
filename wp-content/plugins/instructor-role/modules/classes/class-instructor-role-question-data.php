<?php
/**
 * Parent Class for processing LearnDash's questions data.
 *
...
if ( ! class_exists( 'Instructor_Role_Question_Data' ) ) {
	/**
	 * Instructor_Role_Question_Data Class.
	 *
	 * @class Instructor_Role_Question_Data
	 */
	class Instructor_Role_Question_Data {
		/**
		 * The single instance of the class.
		 *
		 * @var Instructor_Role_Question_Data
		 * @since 5.4.0
		 */
		...
		*/
		...
		/**
		 * Instructor_Role_Question_Data Instance.
		 *
		 * Ensures only one instance of Instructor_Role_Question_Data is loaded or can be loaded.
		 *
		 * @since 5.4.0
		 * @static
		 * @return Instructor_Role_Question_Data - instance.
		 */
		...
		/**
		 * Instructor_Role_Question_Data Constructor.
		 */

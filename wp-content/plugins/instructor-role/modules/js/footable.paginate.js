(function ($, w, undefined) {
	...
	var defaults = {
		...
		firstText: '&laquo;', // cspell:disable-line
		previousText: '&lsaquo;', // cspell:disable-line
		nextText: '&rsaquo;', // cspell:disable-line
		lastText: '&raquo;', // cspell:disable-line
		limitNavigation: 0,
		limitPreviousText: '...',
		limitNextText: '...'
	};
	...
	function Paginate()
	{
		...
		p.paginate = function (ft, newPage) {
			...
			if (info.currentPage !== newPage) {
				...
				// raise a pre-paging event so that we can cancel the paging if needed
		...
		p.fillPage = function (ft, tbody, pageNumber) {
			...
			tbody.find( '> tr' ).hide();
			$( ft.pageInfo.pages[pageNumber] ).each(
				function () {
					p.showRow( this, ft );
				}
			);

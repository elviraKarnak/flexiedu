...
class Authentication {
	 ...
	 * @var string
	 */
	public const LICENSE_DATA_OPTION_KEY = 'learndash_instructor_role_license';
	 ...
	 * @var string
	 */
	public const PLUGIN_SLUG = 'instructor-role';
	...
	public static function verify_token() {
		$message = __( 'Unfortunately, it appears that the authentication token you have provided is invalid. We kindly request that you re-download the package and attempt to install again. If the issue persists, please do not hesitate to contact our support team for further assistance.', 'wdm_instructor_role' );
		...
		$response = wp_remote_post(
			INSTRUCTOR_ROLE_LICENSING_SITE_URL,
			[
				'body' => [

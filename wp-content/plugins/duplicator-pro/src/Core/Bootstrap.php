...
class Bootstrap
{
    ...
    protected static function registerJsCss()
    {
        ...
        wp_register_style(
            'dup-pro-vendor-bundle',
            DUPLICATOR_PRO_PLUGIN_URL . 'assets/build/css/plugin-vendor' . $min . '.css',
            [],
        ...
        wp_register_script(
            'dup-pro-vendor-bundle',
            DUPLICATOR_PRO_PLUGIN_URL . 'assets/build/js/plugin-vendor' . $min . '.js',
    ...
    public static function enqueueScripts(): void
    {
        ...
        wp_enqueue_script('dup-pro-vendor-bundle');

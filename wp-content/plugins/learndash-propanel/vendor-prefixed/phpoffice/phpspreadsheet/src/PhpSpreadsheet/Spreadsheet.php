...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Iterator;
...
class Spreadsheet implements JsonSerializable
{
     ...
     * Set properties.
     */
    public function setProperties(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Document\Properties $documentProperties): void
    {
     ...
     * Set security.
     */
    public function setSecurity(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Document\Security $documentSecurity): void
    {
    ...
    public function removeDefinedName(string $definedName, ?Worksheet $worksheet = null): self
    {
        ...
        } else if (isset($this->definedNames[$worksheet->getTitle() . '!' . $definedName])) {

...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table\TableStyle;
class Table
{
    /**
     * Table Name.
     ...
     * @param string $column Column name (e.g. A)
     */
    public function getColumn($column): \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column
    {
     ...
     */
    public function getColumnByOffset($columnOffset): \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column
    {
        [$rangeStart, $rangeEnd] = Coordinate::rangeBoundaries($this->range);
    ...
    public function setColumn($columnObjectOrString): self
    {
        ...
        } elseif (is_object($columnObjectOrString) && $columnObjectOrString instanceof \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table\Column) {
     ...
     * Get table Style.
     */
    public function getStyle(): \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table\TableStyle
    {
        return $this->style;
    }
    /**

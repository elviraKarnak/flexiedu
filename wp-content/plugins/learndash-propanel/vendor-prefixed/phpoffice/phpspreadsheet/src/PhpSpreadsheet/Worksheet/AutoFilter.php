...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Internal\WildcardMatch;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule;
class AutoFilter
{
    /**
    ...
    public function setColumn($columnObjectOrString)
    {
        ...
        } elseif (is_object($columnObjectOrString) && $columnObjectOrString instanceof \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column) {
    ...
    protected static function filterTestInCustomDataSet($cellValue, $ruleSet)
    {
        ...
        $returnVal = $join == \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND;
     ...
     * @return mixed[]
     */
    private function dynamicFilterDateRange($dynamicRuleType, \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column &$filterColumn)
    {
        $ruleValues = [];
        ...
        return ['method' => 'filterTestInCustomDataSet', 'arguments' => ['filterRules' => $ruleValues, 'join' => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND]];
    }
    /**
                ...
                case \PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER:
                    ...
                    foreach ($rules as $rule) {
                        ...
                        if ($dynamicRuleType == Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE || $dynamicRuleType == Rule::AUTOFILTER_RULETYPE_DYNAMIC_BELOWAVERAGE) {
                            ...
                            $columnFilterTests[$columnID] = ['method' => 'filterTestInCustomDataSet', 'arguments' => ['filterRules' => $ruleValues, 'join' => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_OR]];
                        } else if ($dynamicRuleType[0] == 'M' || $dynamicRuleType[0] == 'Q') {
                            $periodType = '';
                            $period = 0;
                            //    Month or Quarter

...
namespace LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
...
class BSE
{
     ...
     * Set the BLIP.
     */
    public function setBlip(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip $blip): void
    {
        $this->blip = $blip;
        $blip->setParent($this);
    }

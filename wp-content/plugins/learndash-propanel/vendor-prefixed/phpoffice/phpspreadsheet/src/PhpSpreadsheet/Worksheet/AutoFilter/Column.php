...
namespace LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter;

use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Exception as PhpSpreadsheetException;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter;
class Column
{
     ...
     * @return $this
     */
    public function addRule(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column\Rule $rule)
    {
        $this->setEvaluatedFalse();
        $rule->setParent($this);
        $this->ruleset[] = $rule;

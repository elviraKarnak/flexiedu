...
class NumberFormat extends Supervisor
{
    ...
    public function applyFromArray(array $styleArray)
    {
        ...
        } else if (isset($styleArray['formatCode'])) {
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\NumberFormat\Formatter::toFormattedString($value, $format, $callBack);
    }

...
class MathTrig
{
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Arabic::evaluate($roman);
    }
    /**
     * ATAN2.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Tangent::atan2($xCoordinate, $yCoordinate);
    }
    /**
     * BASE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Base::evaluate($number, $radix, $minLength);
    }
    /**
     * CEILING.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Ceiling::ceiling($number, $significance);
    }
    /**
     * COMBIN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Combinations::withoutRepetition($numObjs, $numInSet);
    }
    /**
     * EVEN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::even($number);
    }
    /**
    ...
    {
        return (int) \PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::getEven($number);
    }
    /**
     * FACT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Factorial::fact($factVal);
    }
    /**
     * FACTDOUBLE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Factorial::factDouble($factVal);
    }
    /**
     * FLOOR.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Floor::floor($number, $significance);
    }
    /**
     * FLOOR.MATH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Floor::math($number, $significance, $mode);
    }
    /**
     * FLOOR.PRECISE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Floor::precise($number, $significance);
    }
    /**
     * INT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\IntClass::evaluate($number);
    }
    /**
     * GCD.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Gcd::evaluate(...$args);
    }
    /**
     * LCM.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Lcm::evaluate(...$args);
    }
    /**
     * LOG_BASE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Logarithms::withBase($number, $base);
    }
    /**
     * MDETERM.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\MatrixFunctions::determinant($matrixValues);
    }
    /**
     * MINVERSE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\MatrixFunctions::inverse($matrixValues);
    }
    /**
     * MMULT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\MatrixFunctions::multiply($matrixData1, $matrixData2);
    }
    /**
     * MOD.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Operations::mod($a, $b);
    }
    /**
     * MROUND.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::multiple($number, $multiple);
    }
    /**
     * MULTINOMIAL.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Factorial::multinomial(...$args);
    }
    /**
     * ODD.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::odd($number);
    }
    /**
     * POWER.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Operations::power($x, $y);
    }
    /**
     * PRODUCT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Operations::product(...$args);
    }
    /**
     * QUOTIENT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Operations::quotient($numerator, $denominator);
    }
    /**
     * RAND/RANDBETWEEN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Random::randBetween($min, $max);
    }
    /**
     * ROMAN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Roman::evaluate($aValue, $style);
    }
    /**
     * ROUNDUP.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::up($number, $digits);
    }
    /**
     * ROUNDDOWN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::down($number, $digits);
    }
    /**
     * SERIESSUM.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\SeriesSum::evaluate($x, $n, $m, ...$args);
    }
    /**
     * SIGN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sign::evaluate($number);
    }
    /**
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::returnSign($number);
    }
    /**
     * SQRTPI.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sqrt::pi($number);
    }
    /**
     * SUBTOTAL.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Subtotal::evaluate($functionType, ...$args);
    }
    /**
     * SUM.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sum::sumIgnoringStrings(...$args);
    }
    /**
     * SUMIF.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Conditional::SUMIF($range, $criteria, $sumRange);
    }
    /**
     * SUMIFS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Conditional::SUMIFS(...$args);
    }
    /**
     * SUMPRODUCT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sum::product(...$args);
    }
    /**
     * SUMSQ.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\SumSquares::sumSquare(...$args);
    }
    /**
     * SUMX2MY2.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\SumSquares::sumXSquaredMinusYSquared($matrixData1, $matrixData2);
    }
    /**
     * SUMX2PY2.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\SumSquares::sumXSquaredPlusYSquared($matrixData1, $matrixData2);
    }
    /**
     * SUMXMY2.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\SumSquares::sumXMinusYSquared($matrixData1, $matrixData2);
    }
    /**
     * TRUNC.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trunc::evaluate($value, $digits);
    }
    /**
     * SEC.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Secant::sec($angle);
    }
    /**
     * SECH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Secant::sech($angle);
    }
    /**
     * CSC.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosecant::csc($angle);
    }
    /**
     * CSCH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosecant::csch($angle);
    }
    /**
     * COT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cotangent::cot($angle);
    }
    /**
     * COTH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cotangent::coth($angle);
    }
    /**
     * ACOT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cotangent::acot($number);
    }
    /**
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers::numberOrNan($result);
    }
    /**
     * ACOTH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cotangent::acoth($number);
    }
    /**
     * ROUND.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Round::round($number, $precision);
    }
    /**
     * ABS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Absolute::evaluate($number);
    }
    /**
     * ACOS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosine::acos($number);
    }
    /**
     * ACOSH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosine::acosh($number);
    }
    /**
     * ASIN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Sine::asin($number);
    }
    /**
     * ASINH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Sine::asinh($number);
    }
    /**
     * ATAN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Tangent::atan($number);
    }
    /**
     * ATANH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Tangent::atanh($number);
    }
    /**
     * COS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosine::cos($number);
    }
    /**
     * COSH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Cosine::cosh($number);
    }
    /**
     * DEGREES.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Angle::toDegrees($number);
    }
    /**
     * EXP.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Exp::evaluate($number);
    }
    /**
     * LN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Logarithms::natural($number);
    }
    /**
     * LOG10.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Logarithms::base10($number);
    }
    /**
     * RADIANS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Angle::toRadians($number);
    }
    /**
     * SIN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Sine::sin($number);
    }
    /**
     * SINH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Sine::sinh($number);
    }
    /**
     * SQRT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Sqrt::sqrt($number);
    }
    /**
     * TAN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Tangent::tan($number);
    }
    /**
     * TANH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig\Tangent::tanh($number);
    }
    /**

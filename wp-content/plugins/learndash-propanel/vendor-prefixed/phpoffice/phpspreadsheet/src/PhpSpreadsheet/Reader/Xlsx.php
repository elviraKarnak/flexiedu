...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Cell\Hyperlink;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\DefinedName;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Security\XmlScanner;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\AutoFilter;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Chart;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ColumnAndRowAttributes;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\ConditionalStyles;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\DataValidations;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Hyperlinks;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Namespaces;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\PageSetup;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Properties as PropertyReader;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SharedFormula;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViewOptions;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\SheetViews;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\TableReader;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Theme;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx\WorkbookView;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Drawing;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\File;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Font;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font as StyleFont;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Drawing();
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {

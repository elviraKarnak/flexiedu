...
namespace LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\RichText\Run;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\StringHelper;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Xls;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Border;
...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
    /**
     ...
     * Sheet object.
     *
     * @var \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
    /**
     * Escher object corresponding to MSODRAWING.
     *
     * @var null|\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
    /**
     ...
     * @param \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet The worksheet to write
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    public function close(): void
    {
        ...
        if (($defaultWidth = $phpSheet->getDefaultColumnDimension()->getWidth()) < 0) {
            $defaultWidth = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Font::getDefaultColumnWidthByFont($phpSheet->getParentOrThrow()->getDefaultStyle()->getFont());
        }
     ...
     * Get Escher object.
     */
    public function getEscher(): ?\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher
    {
        return $this->escher;
    }
    /**
     * Set Escher object.
     */
    public function setEscher(?\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Escher $escher): void
    {
        $this->escher = $escher;
    }
    /**
    ...
    private function writeCFRule(ConditionalHelper $conditionalFormulaHelper, Conditional $conditional, string $cellRange): void
    {
        ...
        if ($bFormatFont == 1) {
            ...
            // Font color index
            $colorIdx = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFont()->getColor(), 0x0);
        ...
        if ($bFormatAlign === 1) {
            ...
            $blockAlign = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::horizontal($conditional->getStyle()->getAlignment());
            $blockAlign |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::wrap($conditional->getStyle()->getAlignment()) << 3;
            $blockAlign |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::vertical($conditional->getStyle()->getAlignment()) << 4;
            $blockAlign |= 0 << 7;
            // Text rotation angle
        ...
        if ($bFormatBorder === 1) {
            $blockLineStyle = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getLeft());
            $blockLineStyle |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getRight()) << 4;
            $blockLineStyle |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getTop()) << 8;
            $blockLineStyle |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getBottom()) << 12;
            ...
            $blockColor |= \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getDiagonal()) << 21;
            $dataBlockBorder = pack('vv', $blockLineStyle, $blockColor);
        }
        if ($bFormatFill === 1) {
            // Fill Pattern Style
            $blockFillPatternStyle = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellFill::style($conditional->getStyle()->getFill());
            // Background Color
            $colorIdxBg = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFill()->getStartColor(), 0x41);
            // Foreground Color
            $colorIdxFg = \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFill()->getEndColor(), 0x40);

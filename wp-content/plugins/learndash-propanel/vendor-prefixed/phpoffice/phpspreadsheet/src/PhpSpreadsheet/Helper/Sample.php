...
namespace LearnDash\Reports\PhpOffice\PhpSpreadsheet\Helper;

use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Chart;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\IOFactory;
...
class Sample
{
    ...
    public function renderChart(Chart $chart, string $fileName): void
    {
        ...
        Settings::setChartRenderer(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Renderer\MtJpGraphRenderer::class);

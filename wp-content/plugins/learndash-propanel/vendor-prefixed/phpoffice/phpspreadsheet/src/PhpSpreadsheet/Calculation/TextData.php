...
class TextData
{
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\CharacterConvert::character($character);
    }
    /**
     * TRIMNONPRINTABLE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Trim::nonPrintable($stringValue);
    }
    /**
     * TRIMSPACES.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Trim::spaces($stringValue);
    }
    /**
     * ASCIICODE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\CharacterConvert::code($characters);
    }
    /**
     * CONCATENATE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::CONCATENATE(...$args);
    }
    /**
     * DOLLAR.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::DOLLAR($value, $decimals);
    }
    /**
     * FIND.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Search::sensitive($needle, $haystack, $offset);
    }
    /**
     * SEARCH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Search::insensitive($needle, $haystack, $offset);
    }
    /**
     * FIXEDFORMAT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::FIXEDFORMAT($value, $decimals, $no_commas);
    }
    /**
     * LEFT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::left($value, $chars);
    }
    /**
     * MID.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::mid($value, $start, $chars);
    }
    /**
     * RIGHT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::right($value, $chars);
    }
    /**
     * STRINGLENGTH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::length($value);
    }
    /**
     * LOWERCASE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::lower($mixedCaseString);
    }
    /**
     * UPPERCASE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::upper($mixedCaseString);
    }
    /**
     * PROPERCASE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::proper($mixedCaseString);
    }
    /**
     * REPLACE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Replace::replace($oldText, $start, $chars, $newText);
    }
    /**
     * SUBSTITUTE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Replace::substitute($text, $fromText, $toText, $instance);
    }
    /**
     * RETURNSTRING.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::test($testValue);
    }
    /**
     * TEXTFORMAT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::TEXTFORMAT($value, $format);
    }
    /**
     * VALUE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::VALUE($value);
    }
    /**
     * NUMBERVALUE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::NUMBERVALUE($value, $decimalSeparator, $groupSeparator);
    }
    /**
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::exact($value1, $value2);
    }
    /**
     * TEXTJOIN.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::TEXTJOIN($delimiter, $ignoreEmpty, ...$args);
    }
    /**
     * REPT.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::builtinREPT($str, $number);
    }
}
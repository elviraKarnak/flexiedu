...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Properties;
...
class Chart extends WriterPart
{
     ...
     */
    public function writeChart(\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Chart $chart, $calculateCellValues = true)
    {
        // Create XML writer
        $objWriter = null;

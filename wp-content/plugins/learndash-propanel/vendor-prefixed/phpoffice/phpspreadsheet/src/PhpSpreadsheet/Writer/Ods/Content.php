...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Row;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\RowCellIterator;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Exception;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Ods;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Comment;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Ods\Cell\Style;
...
//                $objWriter->writeAttribute('table:number-columns-repeated', self::NUMBER_COLS_REPEATED_MAX);
    ...
    private function writeCells(XMLWriter $objWriter, RowCellIterator $cells): void
    {
        ...
        foreach ($cells as $cell) {
            /** @var \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Cell\Cell $cell */

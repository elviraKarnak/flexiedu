...
class DateTime
{
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::isLeapYear($year);
    }
    /**
     * getDateValue.
     *
    ...
    {
        try {
            return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Helpers::getDateValue($dateValue);
        } catch (Exception $e) {
            return $e->getMessage();
        }
    }
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Current::now();
    }
    /**
     * DATENOW.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Current::today();
    }
    /**
     * DATE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Date::fromYMD($year, $month, $day);
    }
    /**
     * TIME.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Time::fromHMS($hour, $minute, $second);
    }
    /**
     * DATEVALUE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\DateValue::fromString($dateValue);
    }
    /**
     * TIMEVALUE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\TimeValue::fromString($timeValue);
    }
    /**
     * DATEDIF.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Difference::interval($startDate, $endDate, $unit);
    }
    /**
     * DAYS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Days::between($endDate, $startDate);
    }
    /**
     * DAYS360.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Days360::between($startDate, $endDate, $method);
    }
    /**
     * YEARFRAC.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\YearFrac::fraction($startDate, $endDate, $method);
    }
    /**
     * NETWORKDAYS.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\NetworkDays::count($startDate, $endDate, ...$dateArgs);
    }
    /**
     * WORKDAY.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\WorkDay::date($startDate, $endDays, ...$dateArgs);
    }
    /**
     * DAYOFMONTH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\DateParts::day($dateValue);
    }
    /**
     * WEEKDAY.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Week::day($dateValue, $style);
    }
    /**
     * STARTWEEK_SUNDAY.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Week::number($dateValue, $method);
    }
    /**
     * ISOWEEKNUM.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Week::isoWeekNumber($dateValue);
    }
    /**
     * MONTHOFYEAR.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\DateParts::month($dateValue);
    }
    /**
     * YEAR.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\DateParts::year($dateValue);
    }
    /**
     * HOUROFDAY.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\TimeParts::hour($timeValue);
    }
    /**
     * MINUTE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\TimeParts::minute($timeValue);
    }
    /**
     * SECOND.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\TimeParts::second($timeValue);
    }
    /**
     * EDATE.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Month::adjust($dateValue, $adjustmentMonths);
    }
    /**
     * EOMONTH.
     *
    ...
    {
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel\Month::lastDay($dateValue, $adjustmentMonths);
    }
}
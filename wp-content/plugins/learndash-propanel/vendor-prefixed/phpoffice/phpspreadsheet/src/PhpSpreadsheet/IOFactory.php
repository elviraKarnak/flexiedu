...
abstract class IOFactory
{
    ...
    /** @var string[] */
    private static $readers = [self::READER_XLSX => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx::class, self::READER_XLS => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xls::class, self::READER_XML => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xml::class, self::READER_ODS => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Ods::class, self::READER_SLK => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Slk::class, self::READER_GNUMERIC => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Gnumeric::class, self::READER_HTML => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Html::class, self::READER_CSV => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Csv::class];
    /** @var string[] */
    private static $writers = [self::WRITER_XLS => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xls::class, self::WRITER_XLSX => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Xlsx::class, self::WRITER_ODS => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Ods::class, self::WRITER_CSV => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Csv::class, self::WRITER_HTML => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Html::class, 'Tcpdf' => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Pdf\Tcpdf::class, 'Dompdf' => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Pdf\Dompdf::class, 'Mpdf' => \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Writer\Pdf\Mpdf::class];
    /**

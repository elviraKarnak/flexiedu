...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Axis;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\AxisText;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\GridLines;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Title;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
    ...
    public function readChart(SimpleXMLElement $chartElements, $chartName)
    {
        ...
        $chart = new \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {

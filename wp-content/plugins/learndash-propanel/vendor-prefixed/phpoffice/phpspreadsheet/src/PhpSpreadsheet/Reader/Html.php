...
class Html extends BaseReader
{
        ...
        if (is_string($cellContent)) {
            ...
            if (trim($cellContent) > '') {
                ...
                if (isset($attributeArray['data-type'])) {
                    ...
                    } catch (\LearnDash\Reports\PhpOffice\PhpSpreadsheet\Exception $exception) {
    ...
    public function getStyleColor($value)
    {
        ...
        return \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Helper\Html::colourNameLookup($value);
    }

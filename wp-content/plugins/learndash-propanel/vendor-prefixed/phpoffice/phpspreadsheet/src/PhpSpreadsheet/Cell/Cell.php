...
namespace LearnDash\Reports\PhpOffice\PhpSpreadsheet\Cell;

use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Calculation;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\Date as SharedDate;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Shared\StringHelper;
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\CellStyleAssessor;
...
use LearnDash\Reports\PhpOffice\PhpSpreadsheet\Worksheet\Table;
    ...
    public static function setCalculateDateTimeType(int $calculateDateTimeType): void
    {
        switch ($calculateDateTimeType) {
            ...
            case self::CALCULATE_TIME_FLOAT:
                ...
                break;
            default:
                throw new \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Exception("Invalid value $calculateDateTimeType for calculated date time type");
        }
    }
    ...
    public function getCalculatedValue(bool $resetLog = true)
    {
        if ($this->dataType === DataType::TYPE_FORMULA) {
            try {
                ...
                throw new \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Calculation\Exception(

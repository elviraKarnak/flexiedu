...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension($pixelValue, \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
     ...
     * @param \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels($cellWidth, \LearnDash\Reports\PhpOffice\PhpSpreadsheet\Style\Font $defaultFont)
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();

 ...
 * LearnDash_Reports_HTMLPurifier_Lexer_DirectLex,and is the default choice for PHP 5.
 *
...
class LearnDash_Reports_HTMLPurifier_Lexer_DOMLex extends LearnDash_Reports_HTMLPurifier_Lexer
{

    /**
     * @type LearnDash_Reports_HTMLPurifier_TokenFactory
     */
    private $factory;
    ...
    public function __construct()
    {
        // setup the factory
        parent::__construct();
        $this->factory = new LearnDash_Reports_HTMLPurifier_TokenFactory();
    }
     ...
     * @param LearnDash_Reports_HTMLPurifier_Token[] $tokens   Array-list of already tokenized tokens.
     */
    ...
    protected function createStartNode($node, &$tokens, $collect, $config)
    {
        ...
        if ($node->nodeType === XML_TEXT_NODE) {
            ...
            if ($last instanceof LearnDash_Reports_HTMLPurifier_Token_Start && ($last->name == 'script' || $last->name == 'style')) {
                $new_data = trim($data);

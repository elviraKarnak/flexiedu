 ...
 */
class LearnDash_Reports_HTMLPurifier_TagTransform_Font extends LearnDash_Reports_HTMLPurifier_TagTransform
{
    /**
     * @type string
     */
     ...
     * @return LearnDash_Reports_HTMLPurifier_Token_End|string
     */
    public function transform($tag, $config, $context)
    {
        if ($tag instanceof LearnDash_Reports_HTMLPurifier_Token_End) {
            $new_tag = clone $tag;

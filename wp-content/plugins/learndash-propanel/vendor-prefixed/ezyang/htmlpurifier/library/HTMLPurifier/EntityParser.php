 ...
 */
class LearnDash_Reports_HTMLPurifier_EntityParser
{

    /**
     * Reference to entity lookup table.
     * @type LearnDash_Reports_HTMLPurifier_EntityLookup
     */
    ...
    protected function entityCallback($matches)
    {
        ...
        if ($hex_part !== NULL && $hex_part !== "") {
            return LearnDash_Reports_HTMLPurifier_Encoder::unichr(hexdec($hex_part));
        } elseif ($dec_part !== NULL && $dec_part !== "") {
            return LearnDash_Reports_HTMLPurifier_Encoder::unichr((int) $dec_part);
        } else {
            if (!$this->_entity_lookup) {
                $this->_entity_lookup = LearnDash_Reports_HTMLPurifier_EntityLookup::instance();
            }
    ...
    protected function nonSpecialEntityCallback($matches)
    {
        ...
        if ($is_num) {
            ...
            return LearnDash_Reports_HTMLPurifier_Encoder::unichr($code);
        } else {

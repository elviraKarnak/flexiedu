 ...
 */
abstract class LearnDash_Reports_HTMLPurifier_DefinitionCache
{
    /**
     * @type string
     */
     ...
     * @param LearnDash_Reports_HTMLPurifier_Config $config Instance of LearnDash_Reports_HTMLPurifier_Config to test against
     * @return bool
     */
     ...
     * @param LearnDash_Reports_HTMLPurifier_Definition $def Definition object to check

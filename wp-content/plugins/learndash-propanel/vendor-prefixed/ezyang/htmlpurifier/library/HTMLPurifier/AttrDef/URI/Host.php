 ...
 */
class LearnDash_Reports_HTMLPurifier_AttrDef_URI_Host extends LearnDash_Reports_HTMLPurifier_AttrDef
{

    /**
     * IPv4 sub-validator.
     * @type LearnDash_Reports_HTMLPurifier_AttrDef_URI_IPv4
     */
    protected $ipv4;

    /**
     * IPv6 sub-validator.
     * @type LearnDash_Reports_HTMLPurifier_AttrDef_URI_IPv6
     */
    protected $ipv6;

    public function __construct()
    {
        $this->ipv4 = new LearnDash_Reports_HTMLPurifier_AttrDef_URI_IPv4();
        $this->ipv6 = new LearnDash_Reports_HTMLPurifier_AttrDef_URI_IPv6();
    }

 ...
 * are best described LearnDash_Reports_HTMLPurifier_Strategy_MakeWellFormed->processToken()
 * documentation.
 *
 * @todo Allow injectors to request a re-run on their output. This
 *       would help if an operation is recursive.
 */
abstract class LearnDash_Reports_HTMLPurifier_Injector
{
     ...
     * @param LearnDash_Reports_HTMLPurifier_Token $current Current token variable.
    ...
    protected function forwardUntilEndToken(&$i, &$current, &$nesting)
    {
        ...
        if ($current instanceof LearnDash_Reports_HTMLPurifier_Token_Start) {
            $nesting++;
        } elseif ($current instanceof LearnDash_Reports_HTMLPurifier_Token_End) {
            if ($nesting <= 0) {
                return false;
            }
            $nesting--;
     ...
     * @param LearnDash_Reports_HTMLPurifier_Token $token Current token variable.

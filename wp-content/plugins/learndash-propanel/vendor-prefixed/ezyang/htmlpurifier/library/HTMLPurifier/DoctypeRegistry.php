...
class LearnDash_Reports_HTMLPurifier_DoctypeRegistry
{
     ...
     * @return LearnDash_Reports_HTMLPurifier_Doctype Editable registered doctype
     */
    public function register(
        ...
        if (!is_object($doctype)) {
            $doctype = new LearnDash_Reports_HTMLPurifier_Doctype(
                $doctype,
                $xml,
                $modules,
                $tidy_modules,
     ...
     * @return LearnDash_Reports_HTMLPurifier_Doctype Editable doctype object
     */
    public function get($doctype)
    {
        ...
        if (!isset($this->doctypes[$doctype])) {
            ...
            $anon = new LearnDash_Reports_HTMLPurifier_Doctype($doctype);
            return $anon;
        }
     ...
     * @return LearnDash_Reports_HTMLPurifier_Doctype
     */

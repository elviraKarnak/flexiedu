...
class LearnDash_Reports_HTMLPurifier_Printer_HTMLDefinition extends LearnDash_Reports_HTMLPurifier_Printer
{

    /**
     * @type LearnDash_Reports_HTMLPurifier_HTMLDefinition, for easy access
     */
    protected $def;
    ...
    public function render($config)
    {
        ...
        $ret .= $this->start('div', array('class' => 'LearnDash_Reports_HTMLPurifier_Printer'));
     ...
     * @param LearnDash_Reports_HTMLPurifier_ChildDef $def LearnDash_Reports_HTMLPurifier_ChildDef of pertinent element
     * @return string
     */
     ...
     * @param array $array Array hash in form of array('attrname' => LearnDash_Reports_HTMLPurifier_AttrDef)
     * @return string
     */

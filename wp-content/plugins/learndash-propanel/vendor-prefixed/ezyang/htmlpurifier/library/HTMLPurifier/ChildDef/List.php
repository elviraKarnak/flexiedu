 ...
 */
class LearnDash_Reports_HTMLPurifier_ChildDef_List extends LearnDash_Reports_HTMLPurifier_ChildDef
{
    /**
     * @type string
     */
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            ...
            if ($node->name === 'li') {
                ...
                if ($current_li === null) {
                    $current_li = new LearnDash_Reports_HTMLPurifier_Node_Element('li');
                    $result[] = $current_li;
                }

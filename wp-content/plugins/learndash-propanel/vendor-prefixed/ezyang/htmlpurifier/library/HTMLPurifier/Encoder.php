 ...
 */
class LearnDash_Reports_HTMLPurifier_Encoder
{
    ...
    {
        set_error_handler(array('LearnDash_Reports_HTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
     ...
     * Arguably this function should be modernized to the LearnDash_Reports_HTML5 set
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        $bug = LearnDash_Reports_HTMLPurifier_Encoder::testIconvTruncateBug();

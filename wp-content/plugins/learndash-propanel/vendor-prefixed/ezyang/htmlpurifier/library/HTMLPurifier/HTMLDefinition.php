 ...
 */
class LearnDash_Reports_HTMLPurifier_HTMLDefinition extends LearnDash_Reports_HTMLPurifier_Definition
{

    // FULLY-PUBLIC VARIABLES ---------------------------------------------

    /**
     * Associative array of element names to LearnDash_Reports_HTMLPurifier_ElementDef.
     * @type LearnDash_Reports_HTMLPurifier_ElementDef[]
     */
    public $info = array();
    ...
    /**
     * Associative array of deprecated tag name to LearnDash_Reports_HTMLPurifier_TagTransform.
     * @type array
     */
    public $info_tag_transform = array();

    /**
     * Indexed list of LearnDash_Reports_HTMLPurifier_AttrTransform to be performed before validation.
     * @type LearnDash_Reports_HTMLPurifier_AttrTransform[]
     */
    public $info_attr_transform_pre = array();

    /**
     * Indexed list of LearnDash_Reports_HTMLPurifier_AttrTransform to be performed after validation.
     * @type LearnDash_Reports_HTMLPurifier_AttrTransform[]
     */
    ...
    /**
     * Indexed list of LearnDash_Reports_HTMLPurifier_Injector to be used.
    ...
    /**
     * Doctype object
     * @type LearnDash_Reports_HTMLPurifier_Doctype
     */
    public $doctype;
     ...
     *       method in LearnDash_Reports_HTMLPurifier_HTMLModule
     ...
     *             LearnDash_Reports_HTMLPurifier_AttrTypes for details
     */
     ...
     * @see LearnDash_Reports_HTMLPurifier_HTMLModule::addElement() for detailed
     ...
     * @return LearnDash_Reports_HTMLPurifier_ElementDef
     * @see LearnDash_Reports_HTMLPurifier_HTMLModule::addBlankElement() for detailed
     *       parameter and return value descriptions.
     */
     ...
     * module.
     * @return LearnDash_Reports_HTMLPurifier_HTMLModule
     */
    public function getAnonymousModule()
    {
        if (!$this->_anonModule) {
            $this->_anonModule = new LearnDash_Reports_HTMLPurifier_HTMLModule();
    ...
    /**
     * @type LearnDash_Reports_HTMLPurifier_HTMLModuleManager
     */
    public $manager;
    ...
    {
        $this->manager = new LearnDash_Reports_HTMLPurifier_HTMLModuleManager();
    }

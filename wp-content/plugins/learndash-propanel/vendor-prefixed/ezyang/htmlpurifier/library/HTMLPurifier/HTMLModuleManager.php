...
class LearnDash_Reports_HTMLPurifier_HTMLModuleManager
{

    /**
     * @type LearnDash_Reports_HTMLPurifier_DoctypeRegistry
     */
    public $doctypes;
    ...
    /**
     * @type LearnDash_Reports_HTMLPurifier_AttrTypes
     */
    public $attrTypes;
     ...
     * @type LearnDash_Reports_HTMLPurifier_HTMLModule[]
     */
    public $modules = array();

    /**
     * Array of recognized LearnDash_Reports_HTMLPurifier_HTMLModule instances,
    ...
    /**
     * @type LearnDash_Reports_HTMLPurifier_ContentSets
     */
    public $contentSets;

    /**
     * @type LearnDash_Reports_HTMLPurifier_AttrCollections
     */
    ...
    public function __construct()
    {
        ...
        $this->attrTypes = new LearnDash_Reports_HTMLPurifier_AttrTypes();
        $this->doctypes  = new LearnDash_Reports_HTMLPurifier_DoctypeRegistry();
     ...
     *                LearnDash_Reports_HTMLPurifier_HTMLModule prefix, or instance of
     *                subclass of LearnDash_Reports_HTMLPurifier_HTMLModule.
    ...
    public function setup($config)
    {
        ...
        $this->contentSets = new LearnDash_Reports_HTMLPurifier_ContentSets(
            // content set assembly deals with all possible modules,
            // not just ones deemed to be "safe"
            $this->modules
        );
        $this->attrCollections = new LearnDash_Reports_HTMLPurifier_AttrCollections(
            $this->attrTypes,
     ...
     * @return Array of LearnDash_Reports_HTMLPurifier_ElementDef
     */
     ...
     * @return LearnDash_Reports_HTMLPurifier_ElementDef Merged LearnDash_Reports_HTMLPurifier_ElementDef

...
class LearnDash_Reports_HTMLPurifier_HTMLModule_Legacy extends LearnDash_Reports_HTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $li->attr['value'] = new LearnDash_Reports_HTMLPurifier_AttrDef_Integer();
        $li->attr['type'] = 'Enum#s:1,i,I,a,A,disc,square,circle';

        $ol = $this->addBlankElement('ol');
        $ol->attr['compact'] = 'Bool#compact';
        $ol->attr['start'] = new LearnDash_Reports_HTMLPurifier_AttrDef_Integer();

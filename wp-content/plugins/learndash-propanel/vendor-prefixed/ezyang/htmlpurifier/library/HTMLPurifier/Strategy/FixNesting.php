...
class LearnDash_Reports_HTMLPurifier_Strategy_FixNesting extends LearnDash_Reports_HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = LearnDash_Reports_HTMLPurifier_Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            while (isset($node->children[$ix])) {
                ...
                if ($child instanceof LearnDash_Reports_HTMLPurifier_Node_Element) {
                    $go = true;
        ...
        return LearnDash_Reports_HTMLPurifier_Arborize::flatten($node, $config, $context);
    }
}

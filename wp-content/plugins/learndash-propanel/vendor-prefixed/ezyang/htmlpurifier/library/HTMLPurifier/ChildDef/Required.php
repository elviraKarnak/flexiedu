 ...
 */
class LearnDash_Reports_HTMLPurifier_ChildDef_Required extends LearnDash_Reports_HTMLPurifier_ChildDef
{
    /**
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        while (!empty($stack)) {
            ...
            if (!isset($this->elements[$node->name])) {
                ...
                if ($pcdata_allowed && $node instanceof LearnDash_Reports_HTMLPurifier_Node_Text) {
                    $result[] = $node;
                    continue;
                }

 ...
 */
class LearnDash_Reports_HTMLPurifier_ChildDef_Table extends LearnDash_Reports_HTMLPurifier_ChildDef
{
    /**
     * @type bool
     */
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            if ($node instanceof LearnDash_Reports_HTMLPurifier_Node_Comment) {
                $ws_accum[] = $node;
                continue;
            }
            switch ($node->name) {
            ...
            foreach($content as $node) {
                ...
                case 'tr':
                    if ($current_tr_tbody === null) {
                        $current_tr_tbody = new LearnDash_Reports_HTMLPurifier_Node_Element('tbody');

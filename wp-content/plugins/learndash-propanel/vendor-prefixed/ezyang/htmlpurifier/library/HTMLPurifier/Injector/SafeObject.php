 ...
 * things safe.
 */
class LearnDash_Reports_HTMLPurifier_Injector_SafeObject extends LearnDash_Reports_HTMLPurifier_Injector
{
    /**
     * @type string
     */
    ...
    public function handleElement(&$token)
    {
        if ($token->name == 'object') {
            ...
            foreach ($this->addParam as $name => $value) {
                $new[] = new LearnDash_Reports_HTMLPurifier_Token_Empty('param', array('name' => $name, 'value' => $value));
            }
            $token = $new;

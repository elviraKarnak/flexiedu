 ...
 */
class LearnDash_Reports_HTMLPurifier_ErrorStruct
{
     ...
     * values for this:
     *  - TOKEN: Instance of LearnDash_Reports_HTMLPurifier_Token
    ...
    public function getChild($type, $id)
    {
        if (!isset($this->children[$type][$id])) {
            $this->children[$type][$id] = new LearnDash_Reports_HTMLPurifier_ErrorStruct();

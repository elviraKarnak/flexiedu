 ...
 */
class LearnDash_Reports_HTMLPurifier_Language
{
    ...
    public function load()
    {
        ...
        $factory = LearnDash_Reports_HTMLPurifier_LanguageFactory::instance();
    ...
    public function formatMessage($key, $args = array())
    {
        ...
        foreach ($args as $i => $value) {
            if (is_object($value)) {
                if ($value instanceof LearnDash_Reports_HTMLPurifier_Token) {

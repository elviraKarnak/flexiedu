 ...
 */
class LearnDash_Reports_HTMLPurifier_AttrValidator
{

    /**
     * Validates the attributes of a token, mutating it as necessary.
     * that has valid tokens
     * @param LearnDash_Reports_HTMLPurifier_Token $token Token to validate.
    ...
    public function validateToken($token, $config, $context)
    {
        ...
        if (!$token instanceof LearnDash_Reports_HTMLPurifier_Token_Start &&
            !$token instanceof LearnDash_Reports_HTMLPurifier_Token_Empty
        ) {
            return;
        }

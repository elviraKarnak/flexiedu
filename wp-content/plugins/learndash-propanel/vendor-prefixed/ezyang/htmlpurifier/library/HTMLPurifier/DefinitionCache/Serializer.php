...
class LearnDash_Reports_HTMLPurifier_DefinitionCache_Serializer extends LearnDash_Reports_HTMLPurifier_DefinitionCache
{
    ...
    /**
     * @param LearnDash_Reports_HTMLPurifier_Config $config
     * @return bool|LearnDash_Reports_HTMLPurifier_Config
     */
    ...
    public function generateBaseDirectoryPath($config)
    {
        ...
        $base = is_null($base) ? HTMLPURIFIER_PREFIX . '/LearnDash_Reports_HTMLPurifier/DefinitionCache/Serializer' : $base;
        return $base;
    }

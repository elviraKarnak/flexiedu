...
class QR
{
    ...
    public function getHouseholdVectors(): LearnDash\Reports\Matrix
    {
        $householdVectors = [];
    ...
    public function getQ(): LearnDash\Reports\Matrix
    {
        $qGrid = [];
        $rowCount = $this->rows;
    ...
    public function getR(): LearnDash\Reports\Matrix
    {
        $rGrid = [];

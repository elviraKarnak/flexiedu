...
use Generator;
use LearnDash\Reports\Matrix\Decomposition\LU;
use LearnDash\Reports\Matrix\Decomposition\QR;
/**
 * Matrix object.
 *
 * @package \Matrix
...
class Matrix
{
     ...
     * @throws Exception
     */
    public function getRows(int $row, int $rowCount = 1): LearnDash\Reports\Matrix
    {
     ...
     * @throws Exception
     */
    public function getColumns(int $column, int $columnCount = 1): LearnDash\Reports\Matrix
    {
     ...
     * @throws Exception
     */
    public function dropRows(int $row, int $rowCount = 1): LearnDash\Reports\Matrix
    {
     ...
     * @throws Exception
     */
    public function dropColumns(int $column, int $columnCount = 1): LearnDash\Reports\Matrix
    {
     ...
     */
    public function solve(Matrix $B): LearnDash\Reports\Matrix
    {

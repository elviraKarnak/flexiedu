 ...
 * @method LearnDash\Reports\Complex asec()
 * @method LearnDash\Reports\Complex asech()
 * @method LearnDash\Reports\Complex asin()
 * @method LearnDash\Reports\Complex asinh()
 * @method Complex atan()
...
class Complex
{
     ...
     * @throws    Exception    If the argument isn't a Complex number or cannot be converted to one
     */
    public static function validateComplexArgument($complex): LearnDash\Reports\Complex
    {

...
namespace LearnDash\Reports\Complex;
...
class Functions
{
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function acos($complex): LearnDash\Reports\Complex
    {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function acosh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     */
    public static function acot($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acoth($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acsc($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acsch($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function asec($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function asech($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function asin($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        $invsqrt = self::sqrt(Operations::subtract(1, Operations::multiply($complex, $complex)));
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function asinh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal() && $complex->getReal() > 1) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function atan($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function atanh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function conjugate($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function cos($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function cosh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function cot($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function coth($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function csc($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function csch($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function exp($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    InvalidArgumentException    If function would result in a division by zero
     */
    public static function inverse($complex): LearnDash\Reports\Complex
    {
     ...
     */
    public static function ln($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
     ...
     * @throws    InvalidArgumentException  If the real and the imaginary parts are both zero
     */
    public static function log2($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            throw new InvalidArgumentException();
     ...
     * @throws    InvalidArgumentException  If the real and the imaginary parts are both zero
     */
    public static function log10($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            throw new InvalidArgumentException();
     ...
     *
     */
    public static function negative($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     */
    public static function pow($complex, $power): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if (!is_numeric($power)) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function sec($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function sech($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sin($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sinh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sqrt($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    InvalidArgumentException    If function would result in a division by zero
     */
    public static function tan($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function tanh($complex): LearnDash\Reports\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        $real = $complex->getReal();
        $imaginary = $complex->getImaginary();

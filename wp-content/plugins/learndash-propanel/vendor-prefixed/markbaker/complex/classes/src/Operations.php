...
class Operations
{
     ...
     * @return    \Complex
     */
    public static function add(...$complexValues): LearnDash\Reports\Complex
    {
     ...
     * @return    \Complex
     */
    public static function divideby(...$complexValues): LearnDash\Reports\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function divideinto(...$complexValues): LearnDash\Reports\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function multiply(...$complexValues): LearnDash\Reports\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function subtract(...$complexValues): LearnDash\Reports\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }

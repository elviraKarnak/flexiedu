...
namespace LearnDash\Reports\ZipStream;

use HashContext;
use LearnDash\Reports\Psr\Http\Message\StreamInterface;
use LearnDash\Reports\ZipStream\Exception\FileNotFoundException;
use LearnDash\Reports\ZipStream\Exception\FileNotReadableException;
use LearnDash\Reports\ZipStream\Exception\OverflowException;
use LearnDash\Reports\ZipStream\Option\File as FileOptions;
use LearnDash\Reports\ZipStream\Option\Method;
use LearnDash\Reports\ZipStream\Option\Version;
class File
{
     ...
     *
     * @return void
     * @throws \LearnDash\Reports\ZipStream\Exception\EncodingException
     */

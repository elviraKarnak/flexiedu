...
namespace LearnDash\Reports\ZipStreamTest;
...
use ReflectionClass;
use ZipArchive;
use LearnDash\Reports\ZipStream\File;
use LearnDash\Reports\ZipStream\Option\Archive as ArchiveOptions;
use LearnDash\Reports\ZipStream\Option\File as FileOptions;
use LearnDash\Reports\ZipStream\Option\Method;
use LearnDash\Reports\ZipStream\Stream;
...
class ZipStreamTest extends TestCase
{
    ...
    {
        $this->expectException(\LearnDash\Reports\ZipStream\Exception\FileNotFoundException::class);
    ...
    public function testFileNotReadableException(): void
    {
        ...
        $zip = new ZipStream();
        $this->expectException(\LearnDash\Reports\ZipStream\Exception\FileNotReadableException::class);

// cspell:ignore livesearch lTfgtip .
/**
...
export default class reportingDashboard {
	...
	paginateReportsTable( pagination_form, limit_selector, page_number_selector, previous_page_btn, next_page_button ) {
		var instance = this;
		jQuery( document ).ready(function(){
			instance.result_filters.change_entry_count( pagination_form, limit_selector );
			instance.result_filters.change_page_number( pagination_form, page_number_selector, previous_page_btn, next_page_button );
		});
	}
	...
	previewCustomReport( container, preview_button, save_button ) {
		...
		jQuery(document).ready(function(){
			...
			jQuery(document).on( 'custom_report_created', function(event, dat) {

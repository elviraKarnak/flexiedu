...
const icon = (
	...
	>
		<path
			d="M8.7,23.7h6.8c1.5,0,2.7-0.5,3.7-1.5c1.1-1.2,1.7-2.9,1.7-4.9c0-3.8-1.8-7.9-4.4-10.2L16.3,7l0.2-0.1
		...
		/>
		<path
			d="M18,13.7l-5.8-2.1l-0.2,0l-5.6,2.1c-0.2,0.1-0.3,0.3-0.3,0.4c0,0.1,0.1,0.3,0.3,0.4l0.4,0.1v2c-0.4,0.1-0.6,0.5-0.6,0.9
...
registerBlockType( 'wisdm-learndash-reports/revenue-from-courses', {
	title: sprintf(
		...
		__( 'Revenue From %s', 'learndash-reports-pro' ),
		wisdm_reports_get_ld_custom_lebel_if_avaiable( 'Courses' )
	),
	description: sprintf(
		// Translators: courses label.
		__(
			'Graph of the revenue earned from the %s during the selected time frame',
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-revenue-from-courses front"></div>
			</div>
		);
	},
} );

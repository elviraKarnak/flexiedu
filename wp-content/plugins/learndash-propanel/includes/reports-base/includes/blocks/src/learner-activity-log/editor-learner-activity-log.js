...
registerBlockType( 'wisdm-learndash-reports/learner-activity-log', {
	title: __( 'Learner Activity Log', 'learndash-reports-pro' ),
	description: __(
		'Report of the Learner Activity Log`',
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-learner-activity-log front"></div>
			</div>
		);
	},
} );

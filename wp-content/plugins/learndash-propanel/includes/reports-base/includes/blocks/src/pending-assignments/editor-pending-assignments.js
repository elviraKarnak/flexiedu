...
const icon = (
	...
	>
		<g>
			<g>
				<path
					d="M17.7,6.6h-5.5c-0.4,0-0.7,0.3-0.7,0.6c-0.1,0.1-0.1,0.3,0,0.4c0.1,0.3,0.4,0.5,0.8,0.5h5.5c0.5,0,0.7-0.4,0.7-0.7
                      C18.4,6.9,18,6.6,17.7,6.6z"
				/>
				<path
					d="M17.7,10.4H6.5c-0.4,0-0.7,0.4-0.7,0.7c-0.1,0.2,0,0.4,0,0.5c0.1,0.2,0.4,0.3,0.7,0.3h11.1c0.5,0,0.7-0.4,0.7-0.7
			...
			<path
				d="M21.1,2.4C20.9,1.6,20.3,1,19.4,1H4.6C3.7,1,2.9,1.8,2.9,2.7l0,9.3l0,9.3c0,0.9,0.7,1.7,1.7,1.7h14.9
...
registerBlockType( 'wisdm-learndash-reports/pending-assignments', {
	title: __( 'Pending Assignments', 'learndash-reports-pro' ),
	description: __(
		'Displays Count of the pending assignments',
	...
	edit( props ) {
		return (
			<div { ...useBlockProps() }>
				<div className="wisdm-learndash-reports-pending-assignments">
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-pending-assignments front"></div>
			</div>
		);
	},
} );

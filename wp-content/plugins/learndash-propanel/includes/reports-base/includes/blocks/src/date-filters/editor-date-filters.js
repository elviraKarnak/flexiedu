...
const icon = (
	...
	>
		<path
			className="st0"
			d="M17.4,12.8c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S18,12.8,17.4,12.8z M17.4,14.8
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9s0.9,0.4,0.9,0.9S17.8,14.8,17.4,14.8z"
		/>
		<path
			className="st0"
			d="M12.1,12.8c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S12.7,12.8,12.1,12.8z M12.1,14.8
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9s0.9,0.4,0.9,0.9S12.6,14.8,12.1,14.8z"
		/>
		<path
			className="st0"
			d="M6.5,17.3c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S7.1,17.3,6.5,17.3z M6.5,19.3
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9s0.9,0.4,0.9,0.9S6.9,19.3,6.5,19.3z"
		/>
		<path
			className="st0"
			d="M6.5,12.8c-0.6,0-1.1,0.5-1.1,1.1S5.9,15,6.5,15s1.1-0.5,1.1-1.1S7.1,12.8,6.5,12.8z M6.5,14.8
                    c-0.5,0-0.9-0.4-0.9-0.9S6,13,6.5,13s0.9,0.4,0.9,0.9S6.9,14.8,6.5,14.8z"
		/>
		<path
			className="st0"
			d="M17.4,8.2c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S18,8.2,17.4,8.2z M17.4,10.2
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9s0.9,0.4,0.9,0.9S17.8,10.2,17.4,10.2z"
		/>
		<path
			className="st0"
			d="M12.1,8.2c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S12.7,8.2,12.1,8.2z M12.1,10.2
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9S13,8.8,13,9.3S12.5,10.2,12.1,10.2z"
		/>
		<path
			className="st0"
			d="M12.1,17.3c-0.6,0-1.1,0.5-1.1,1.1s0.5,1.1,1.1,1.1s1.1-0.5,1.1-1.1S12.7,17.3,12.1,17.3z M12.1,19.3
                    c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9s0.9,0.4,0.9,0.9S12.5,19.3,12.1,19.3z"
		/>
		<circle className="st0" cx="6.5" cy="9.3" r="1.7" />
		<circle className="st0" cx="17.4" cy="18.4" r="1.7" />
		<path
			className="st0"
			d="M19.6,2.7h-1V2.2c0-0.6-0.5-1-1-1c-0.6,0-1,0.5-1,1v0.5h-3.6V2.2c0-0.6-0.5-1-1-1c-0.6,0-1,0.5-1,1v0.5H7.1V2.2
...
registerBlockType( 'wisdm-learndash-reports/date-filters', {
	title: __( 'Duration Selectors', 'learndash-reports-pro' ),
	description: __(
		...
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-chart-block">
					<div className="wisdm-learndash-reports-date-filters front"></div>
				</div>
			</div>
		);
	},

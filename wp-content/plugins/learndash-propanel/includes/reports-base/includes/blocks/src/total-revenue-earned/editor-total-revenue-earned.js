...
const icon = (
	...
	>
		<path
			d="M12.4,18.4l0.2,0c1-0.1,1.8-1,1.8-2c0-1.1-0.9-2-2-2h-0.9c-0.5,0-0.9-0.4-0.9-0.9s0.4-0.9,0.9-0.9h2.5
		...
		/>
		<path
			d="M8.5,23.7h6.8c1.5,0,2.7-0.5,3.7-1.5c1.1-1.2,1.7-2.9,1.7-4.9c0-3.8-1.8-7.9-4.4-10.2L16.1,7l0.2-0.1
...
registerBlockType( 'wisdm-learndash-reports/total-revenue-earned', {
	title: __( 'Total Revenue', 'learndash-reports-pro' ),
	description: __(
		'Displays the total revenue earned during the selected time & its comparison with the previous duration',
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-total-revenue-earned front"></div>
			</div>
		);
	},
} );

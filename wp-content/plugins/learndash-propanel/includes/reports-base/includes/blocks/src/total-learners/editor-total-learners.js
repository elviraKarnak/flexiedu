...
const icon = (
	...
	>
		<g>
			<path
				d="M7.4,10.8L7.4,10.8l0.1,0.1C7.6,12,8.3,13,9.2,13.8l0.8,0.4c1,0.5,2.7,0.5,3.7,0l0.8-0.4c0.9-0.8,1.5-1.8,1.7-2.9v-0.1h0.1
			...
			<g>
				<path
					d="M22,18.9v-0.4c0-1-0.7-1.8-1.6-2.1l-6.2-1.7v-1l-0.9,0.6v0.5L12,16.1l-1.3-1.3v-0.5l-0.9-0.5v0.9l-6.2,1.7
...
registerBlockType( 'wisdm-learndash-reports/total-learners', {
	...
	description: __(
		'Displays Count of the enrolled learners',
	...
	edit( props ) {
		return (
			<div { ...useBlockProps() }>
				<div className="wisdm-learndash-reports-total-learners">
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-total-learners front"></div>
			</div>
		);
	},
} );

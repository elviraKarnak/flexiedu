...
import './editor.scss';
import InactiveUsers from './index-inactive-users.js';
...
registerBlockType( 'wisdm-learndash-reports/inactive-users', {
	title: __( 'Inactive Users', 'learndash-reports-pro' ),
	description: __( 'Report of the Inactive Users', 'learndash-reports-pro' ),
	category: 'wisdm-learndash-reports',
	className: 'learndash-reports-by-wisdmlabs-inactive-users',
	icon,
	apiVersion: '3',
	attributes: {
		categories: {
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-inactive-users front"></div>
			</div>
		);
	},
} );

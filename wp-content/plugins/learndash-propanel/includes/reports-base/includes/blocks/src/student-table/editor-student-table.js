...
import StudentTable from './index-student-table';
...
registerBlockType( 'wisdm-learndash-reports/student-table', {
	title: __( 'Student Table', 'learndash-reports-pro' ),
	description: __( 'Student Table', 'learndash-reports-pro' ),
	category: 'wisdm-learndash-reports',
	className: 'learndash-reports-by-wisdmlabs-student-table',
	icon,
	apiVersion: '3',
	attributes: {},
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-student-table front"></div>
			</div>
		);
	},
} );

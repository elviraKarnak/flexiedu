...
registerBlockType( 'wisdm-learndash-reports/student-profile', {
	title: __( 'Student Profile', 'learndash-reports-pro' ),
	description: __( 'Student Profile', 'learndash-reports-pro' ),
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-student-profile front"></div>
			</div>
		);
	},
} );

	...
	constructor( props ) {
		...
		this.state = {
			...
			help_text: sprintf(
				...
				__(
					'This report displays the average %% of %1$s completion for %2$s.',
		...
		if ( undefined != response.coursewise_statistics ) {
			...
			this.plotBarChart(
				...
				sprintf(
					...
					__( 'Avg %% %s completed', 'learndash-reports-pro' ),
			...
			this.setState( {
				...
				graph_summary: {
					...
					inner_help_text: sprintf(
						// Translators: %1$s: Quizzes label, %2$s: Quizzes label, %3$s: courses label, %4$s: courses label.
						__(
							'Avg Percentage of %1$s Completed = Avg %% of %2$s Completed by learners in all %3$s/No. of %4$s',
							'learndash-reports-pro'
						),
						wisdm_reports_get_ld_custom_lebel_if_avaiable( 'quizzes' ),
						wisdm_reports_get_ld_custom_lebel_if_avaiable( 'quizzes' ),
					...
					help_text:
						...
						global.reportTypeForTooltip == 'default-course-reports'
							? sprintf(
								...
								__(
									'This report displays the %% of learners who have completed all the %1$s in this %2$s.',
									'learndash-reports-pro'
								),
								wisdm_reports_get_ld_custom_lebel_if_avaiable( 'Quizzes', 'lower' ),
							...
							: sprintf(
								// Translators: %s: quizzes label.
								__(
									'This report displays the completion rates of %s attempted by a particular learner.',
									'learndash-reports-pro'
								),
								wisdm_reports_get_ld_custom_lebel_if_avaiable( 'Quizzes', 'lower' )
							),
			...
			this.plotBarChart(
				...
				sprintf(
					...
					__( 'Rate of %s Completion', 'learndash-reports-pro' ),
					wisdm_reports_get_ld_custom_lebel_if_avaiable( 'Quiz' )
				)
			);
			this.setState( {

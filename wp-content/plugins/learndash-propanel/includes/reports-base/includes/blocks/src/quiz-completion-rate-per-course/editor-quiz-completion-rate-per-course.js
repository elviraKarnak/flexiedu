...
const icon = (
	...
	>
		<g>
			<path
				d="M10.6,15H8.7c-0.1,0-0.3,0-0.4,0.1c-0.1,0-0.1,0.1-0.1,0.2v6c0,0,0,0.1,0.1,0.2c0.1,0.1,0.2,0.1,0.4,0.1h2.1
			...
			/>
			<path
				d="M6,15H0.9c-0.4,0-0.7,0.3-0.7,0.7v5.2c0,0.4,0.3,0.7,0.7,0.7H6c0.4,0,0.7-0.3,0.7-0.7v-5.2C6.7,15.3,6.4,15,6,15z
			...
			<path
				d="M11.1,2.6c-0.3-0.1-0.8-0.1-1.1,0C9.9,2.6,9.8,2.7,9.8,2.8L8,8.6c0,0,0,0,0,0.1c0,0,0,0.1,0.2,0.3C8.4,9,8.6,9,8.8,9
			...
			/>
			<path
				d="M6.7,3.2c0-0.4-0.3-0.7-0.7-0.7H0.9c-0.4,0-0.7,0.3-0.7,0.7v5.2C0.2,8.7,0.5,9,0.9,9H6c0.4,0,0.7-0.3,0.7-0.7V3.2z
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-quiz-completion-rate-per-course front"></div>
			</div>
		);
	},
} );

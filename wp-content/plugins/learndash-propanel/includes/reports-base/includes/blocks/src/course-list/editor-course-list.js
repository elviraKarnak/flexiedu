...
import './editor.scss';
import CourseList from './index-course-list.js';
...
registerBlockType( 'wisdm-learndash-reports/course-list', {
	title: sprintf(
		// Translators: %s: Course label.
		__( '%s List', 'learndash-reports-pro' ),
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-course-list"></div>
			</div>
		);
	},
} );

...
const icon = (
	...
	>
		<path
			d="M18,22.2c-3.3,0-6-2.7-6-6c0-3.3,2.7-6,6-6s6,2.7,6,6C24,19.5,21.3,22.2,18,22.2z M18,11.1c-2.9,0-5.2,2.3-5.2,5.2
		...
		/>
		<path
			d="M9.1,8C9,8,8.8,7.9,8.7,7.9l0,0C8.3,7.9,8,8.3,8,8.5v5.3c0,0.3,0.2,0.5,0.3,0.6s0.3,0.1,0.4,0.1c0.1,0,0.2,0,0.3-0.1l4-2.7
                    c0.3-0.2,0.5-0.3,0.5-0.5s-0.1-0.3-0.4-0.5L9.1,8z M11.6,11.2l-2.3,1.4V9.7L11.6,11.2z"
		/>
		<path
			d="M20.4,15.6h-1.6V14c0-0.5-0.3-0.8-0.8-0.8s-0.8,0.3-0.8,0.8v1.6h-1.6c-0.5,0-0.8,0.3-0.8,0.8c0,0.5,0.3,0.8,0.8,0.8h1.6v1.6
...
registerBlockType( 'wisdm-learndash-reports/daily-enrollments', {
	title: __( 'Daily Enrollments', 'learndash-reports-pro' ),
	description: __(
		'Graph of the daily enrollments during the selected time frame',
	...
	save() {
		return (
			<div { ...useBlockProps.save() }>
				<div className="wisdm-learndash-reports-daily-enrollments front"></div>
			</div>
		);
	},
} );

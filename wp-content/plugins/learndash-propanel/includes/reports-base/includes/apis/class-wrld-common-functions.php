	...
	class WRLD_Common_Functions {
		...
		public static function wrld_get_report_filters_data() {
			...
			return new \WP_REST_Response(
				array(
					'wisdm_ld_reports_common_script_data'                      => $data,
					'wisdm_learndash_reports_front_end_script_report_filters'  => $data, // Backwards compatibility alias for the old key name, added in version 3.0.5. Can be deleted later.
				),
				200
			);
		}

...
class Admin_Functions {
	...
	public static function wp_ajax_wrld_gutenberg_block_visit() {
		...
		$option_key = isset( $_REQUEST['option_key'] ) ? sanitize_text_field( wp_unslash( $_REQUEST['option_key'] ) ) : '';
...
<div class="wrap">
	...
	public static function apply_time_tracking_settings() {
		...
		$btn_label = isset( $_POST['btnlabel'] ) ? sanitize_text_field( wp_unslash( $_POST['btnlabel'] ) ) : ''; // cspell:disable-line .

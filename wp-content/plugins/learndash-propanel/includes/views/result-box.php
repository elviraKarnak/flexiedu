...
<div class="wpProQuiz_results">
	...
	<p class="wpProQuiz_quiz_time">
		<?php
		_e( 'Your time: <span></span>', 'learndash-reports-pro' ); // phpcs:ignore WordPress.Security.EscapeOutput.UnsafePrintingFunction
		/* translators: 1: Hours 2: Minutes 3: Seconds. */
		echo esc_html( sprintf( '%02d:%02d:%02d', (int) ( $time / 3600 ), (int) ( $time / 60 ) % 60, (int) $time % 60 ) );
		?>
	</p>

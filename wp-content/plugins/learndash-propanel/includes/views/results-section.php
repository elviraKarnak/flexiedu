...
if ( isset( $_SERVER['QUERY_STRING'] ) ) { // phpcs:ignore
...
<div class="results-section">
	...
	<div class="total_count"><span><?php printf( _n( '%s Report', '%s Reports', $total_count, 'learndash-reports-pro' ), '<strong>' . $total_count . '</strong>' );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span></div>
	...
	<?php if ( $pages > 1 ) : ?>
		<div class="pagination-section">
			...
			<span><?php printf( __( 'Page %1$s of %2$d', 'learndash-reports-pro' ), '<input type="text" class="page" value="' . $page . '" data-max="' . $pages . '"/>', $pages );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>

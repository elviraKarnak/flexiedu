...
class Mpdf implements \LearnDash\Certificate_Builder\Psr\Log\LoggerAwareInterface
{
	...
	public function __construct(array $config = [], $container = null)
	{
		...
		assert(!$container || $container instanceof \LearnDash\Certificate_Builder\Mpdf\Container\ContainerInterface);
	...
	{
		if ($txt instanceof \LearnDash\Certificate_Builder\Mpdf\WatermarkText) {
	...
	{
		if ($src instanceof \LearnDash\Certificate_Builder\Mpdf\WatermarkImage) {

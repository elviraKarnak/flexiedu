...
export default function Edit( props ) {
	...
	const PAGE_ORIENTATION = [
		{
			label: __( 'Landscape (default)', 'learndash-certificate-builder' ),
			value: 'L',
		},
		{
			label: __( 'Portrait', 'learndash-certificate-builder' ),
			value: 'P',
		},
	];
	let styles = {};
	...
	let fontDefine = Helper.buildFontStyle(
		certificate_builder.font_url,
		certificate_builder.fonts
	);
	let fontStyle = '';
	if ( useFont === false ) {
	...
	return (
		<div { ...blockProps }>
			...
			{ controls }
			<div id={ 'certificate-builder-blocks' }>
				<div style={ styles }>
					<img
						src={ backgroundImage }
					...
					>
						...
						>
							<InnerBlocks
								templateLock={ false }
								allowedBlocks={
									certificate_builder.allowed_blocks
								}
							/>
						</div>
					</div>

<?php
/**
 * Gutenberg Block for [learndash_groups_plus].
 *
 * @since 1.0.0
 *
...
class Groups_Plus extends LearnDash_Gutenberg_Block {
	 /**
	  * Object constructor
	  */
	public function __construct() {
		$this->shortcode_slug   = 'learndash_groups_plus';
		$this->block_slug       = 'ld-groups-plus';
		$this->block_dir        = LEARNDASH_GROUPS_PLUS_DIR . 'build/resources/blocks/ld-groups-plus';

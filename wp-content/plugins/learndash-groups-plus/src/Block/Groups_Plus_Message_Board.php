<?php
/**
 * Gutenberg Block for [learndash_groups_plus_message_board].
 *
 * @since 1.0.0
 *
...
class Groups_Plus_Message_Board extends LearnDash_Gutenberg_Block {
	 /**
	  * Object constructor
	  */
	public function __construct() {
		$this->shortcode_slug   = 'learndash_groups_plus_message_board';
		$this->block_slug       = 'ld-groups-plus-message-board';
		$this->block_dir        = LEARNDASH_GROUPS_PLUS_DIR . 'build/resources/blocks/ld-groups-plus-message-board';

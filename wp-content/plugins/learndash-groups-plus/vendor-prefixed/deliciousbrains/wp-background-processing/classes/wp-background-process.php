...
/**
 * Abstract LearnDash_Groups_Plus_WP_Background_Process class.
 *
 * @abstract
 * @extends LearnDash_Groups_Plus_WP_Async_Request
 */
abstract class LearnDash_Groups_Plus_WP_Background_Process extends LearnDash_Groups_Plus_WP_Async_Request {
	/**

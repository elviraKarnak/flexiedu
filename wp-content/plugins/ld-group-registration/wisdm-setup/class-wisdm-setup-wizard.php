...
if ( ! class_exists( 'Wisdm_Setup_Wizard' ) ) {
	class Wisdm_Setup_Wizard {
		...
		public function admin_menus() {
			add_submenu_page( '', '', '', 'manage_options', $this->wizard_handler->get_wizard_page_slug(), '' );
		}
		...
		public function setup_wizard_header() {
			...
			// Enqueue modern WordPress styles and scripts.
			...
			<?php
			// For custom full-screen pages, we need to use the print hooks to output styles and scripts.
			// These hooks actually print the styles/scripts to the HTML output.
			do_action( 'admin_print_styles' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WordPress core admin hooks.
			do_action( 'admin_print_scripts' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WordPress core admin hooks.
			do_action( 'admin_head' ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WordPress core admin hooks.
			?>
			</head>
...
add_action(
	'init',
	function () {
		// Initialize the wizard, and adds the admin hooks.
